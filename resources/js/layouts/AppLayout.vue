...
<template>
   <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
      <Link href="/dashboard" class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white">Auto diely</Link>
          ...
          <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
            ...
            <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
              ...
              <ul class="nav flex-column">
                <li class="nav-item">
                  <Link href="/dashboard" class="nav-link d-flex align-items-center gap-2" 
                ...
                <li class="nav-item">
                  <Link href="/cars" class="nav-link d-flex align-items-center gap-2" :class="{ 'active': page.url === '/cars' }">
                    <svg class="bi" aria-hidden="true">
                ...
                <li class="nav-item">
                  <Link href="/parts" class="nav-link d-flex align-items-center gap-2" :class="{ 'active': page.url === '/parts' }">
                    <svg class="bi" aria-hidden="true">
