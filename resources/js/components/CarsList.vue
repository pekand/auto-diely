...
<template>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
      <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Auto diely</a>
...
<!-------------------------------------------->
<form action="{{ route('cars.store') }}" method="POST" class="p-4 border rounded bg-light">
    <div class="mb-3">
        <label for="name" class="form-label">Car name</label>
        <input type="text" class="form-control" id="name" name="name" placeholder="e.g. Toyota Corolla" required>
    </div>

    <div class="mb-3">
        <label for="registration_number" class="form-label">Registration number</label>
        <input type="text" class="form-control" id="registration_number" name="registration_number" placeholder="e.g. TOY-123" required>
    </div>

    <div class="form-check mb-3">
        <input class="form-check-input" type="checkbox" id="is_registered" name="is_registered" value="1">
    ...
    <div class="mb-3">
        ...
        <select class="form-select" id="car_id" name="car_id" required>
            <option value="">-- Select Car --</option>
                <option value="">Car name (REGISTRATION_NUMBER)</option>
        </select>
    </div>
...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2>Parts</h2>
        <a href="{{ route('parts.create') }}" class="btn btn-success">+ Add New Part</a>
    </div>
